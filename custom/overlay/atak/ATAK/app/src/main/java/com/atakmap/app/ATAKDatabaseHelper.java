...
public class ATAKDatabaseHelper {
    ...
    // DHGM overlay: upstream Cancel on first-run encryption left splash stuck forever.
        ...
        ad.setView(dkView).setPositiveButton(R.string.ok,
                ...
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        // DHGM: upstream Cancel → null listener → splash უსასრულოდ.
                        // პირველ გაშვებაზე გაუქმება = უშიფრავი DB-ით გაგრძელება.
                        if (init && listener != null) {
                            Log.d(TAG, "DHGM: encryption passphrase skipped on first run");
                            AtakAuthenticationDatabase.saveCredentials(
                                    AtakAuthenticationCredentials.TYPE_APK_DOWNLOADER,
                                    "com.atakmap.app.v2", "atakuser", "", false);
