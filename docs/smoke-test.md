...
| # | შემოწმება | მოსალოდნელი |
|---|-----------|-------------|
| 6c.1 | ინგლისურ ტელეფონზე პირველ გაშვება | UI **ქართულია** (ნაგულისხმევი `ka`) |
| 6c.2 | Toolbar → „ენა / Language" | დიალოგ: სისტემის ენა / ქართული / English |
| 6c.3 | English → გამოყენება → გადატვირთვა | UI ინგლისურია (core + plugin + settings) |
